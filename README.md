...
- Navigate to `trampoline-tickets` folder
- Select `trampoline-tickets.bot` file
...
msbot clone services --name "trampoline-tickets" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
